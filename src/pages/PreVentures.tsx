...
export default function PreVentures() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-6">
      ...
      >
        <Compass className="w-8 h-8 mx-auto mb-6" style={{ color: '#7C6FE0' }} />
        <h1 className="font-heading text-[28px] font-bold text-white mb-4">
          You're about to submit a project.
        </h1>
        <p className="text-[16px] leading-[1.7] mb-10" style={{ color: '#666666' }}>
          Tell us what you need. We'll find the right builder for it.
        </p>
